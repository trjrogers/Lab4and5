...
*/
        ...
        // Loop through each index of cards array
        // Generates random number between 1-21 (exclusive) representing the 20 card picture boxes
        // Swaps current index of cards array in loop with the item at index of random generator
        private void ShuffleCards()
        {
            Random generator = new Random();
            for (int i = 1; i <= 20; i++)
